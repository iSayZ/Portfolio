    ...
    return (
        <div className="bg-sky-950 w-full py-12 text-slate-50 relative">
            <div ref={footer} className="relative flex flex-col items-center z-50">
                <h2 className="font-semibold text-lg mb-4 md:text-xl">Mes réseaux sociaux</h2>
                <div className="flex justify-center space-x-3">
                    ...
                    <a href="#" target="" className="hover:opacity-80 hover:scale-105">
                        <img src="../../../assets/social-icons/instagram.svg" alt="" /> 
                    </a>
                </div>
                <h3 className="mt-4 text-sm">© Portfolio | Estrine Alexis 2024 - Tout droits réservés</h3>
            </div>
        </div>
    )
}
