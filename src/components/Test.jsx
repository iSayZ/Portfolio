...
function Test() {
    ...
    return (
        <>
            ...
            <div className="text-white text-2xl md:text-4xl space-y-8 flex flex-col items-center md:items-start justify-center p-10">
            ...
            <div className="">
                <img src="../../assets/profil.jpg" alt="" className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full h-48 w-48 m-auto md:h-64 md:w-64 md:m-0" />
            </div>
            </div>
        </>
    )
