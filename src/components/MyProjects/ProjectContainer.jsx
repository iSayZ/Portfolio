    ...
    <>
      <div className="min-h-auto w-full bg-slate-300 relative rounded">
        <img
          ...
          alt=""
          className="w-full h-full object-fill rounded-tl-sm rounded-tr-sm"
        />
        <div
          onClick={openPopup}
          className="absolute top-0 left-0 right-0 bottom-0 w-full h-full opacity-0 bg-slate-900 rounded-tl-sm rounded-tr-sm flex justify-center items-center cursor-pointer hover:opacity-80"
        >
